# Support for Output Descriptors in Aegisum Core

Since Aegisum Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `aegs1...` for mainnet or `taegs1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Aegisum Core wallets, a convenience function `combo` is
