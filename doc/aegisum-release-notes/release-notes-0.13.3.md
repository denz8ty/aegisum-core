Aegisum Core version 0.13.3 is now available from:

  <https://download.aegisum.org/aegisum-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](/blob/0.13/src/chainparams.cpp#L214).
