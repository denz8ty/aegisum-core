...
bech32_templates = [
  ...
  ('aegs',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('aegs',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('aegs',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('aegs',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('taegs',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('taegs',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('taegs',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('taegs',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('taegs',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('taegs',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('taegs',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('taegs',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('raegs',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('raegs',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('raegs',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('raegs', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('taegs',   17, 32, Encoding.BECH32M, False, False, False),
  ('raegs',  3,  1, Encoding.BECH32M, False, False, False),
  ('aegs',   15, 41, Encoding.BECH32M, False, False, False),
  ('taegs',    0, 16, Encoding.BECH32,  False, False, False),
  ('raegs',  0, 32, Encoding.BECH32,  True,  False, False),
  ('aegs',    0, 16, Encoding.BECH32,  True,  False, False),
  ('taegs',    0, 32, Encoding.BECH32,  False, True,  False),
  ('raegs',  0, 20, Encoding.BECH32,  False, False, True),
  ('aegs',    0, 20, Encoding.BECH32M, False, False, False),
  ('taegs',    0, 32, Encoding.BECH32M, False, False, False),
  ('raegs',  0, 20, Encoding.BECH32M, False, False, False),
  ('aegs',    1, 32, Encoding.BECH32,  False, False, False),
  ('taegs',    2, 16, Encoding.BECH32,  False, False, False),
  ('raegs', 16, 20, Encoding.BECH32,  False, False, False),
]
