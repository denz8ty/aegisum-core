...
class WalletSendTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        for target, mode in product([-1, 0], ["aegs/kb", "sat/b"]):
        ...
        for mode in ["economical", "conservative", "aegs/kb", "sat/b"]:
        ...
        self.test_send(from_wallet=w0, to_wallet=w1, amount=1, change_address="not an address",
                       expect_error=(-5, "Change address must be a valid aegisum address"))
