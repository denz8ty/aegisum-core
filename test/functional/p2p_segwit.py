...
class SegWitTest(BitcoinTestFramework):
    ...
    def test_v0_outputs_arent_spendable(self):
        ...
        for tx in [p2wsh_tx, p2sh_p2wsh_tx]:
            ...
            # Aegisum: BTC applied these rules for all transactions once P2SH is enabled, on AEGS we enforce
    ...
    def test_superfluous_witness(self):
        ...
        self.nodes[0].generate(1)
        unspent = next(u for u in self.nodes[0].listunspent() if u['spendable'] and u['address'].startswith('raegs'))
