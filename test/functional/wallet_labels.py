...
class WalletLabelsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        BECH32_VALID = {
            '✔️_VER15_PROG40': 'raegs10qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqevpw9x',
            '✔️_VER16_PROG03': 'raegs1sqqqqqap5g4h',
            '✔️_VER16_PROB02': 'raegs1sqqqqfsjxnh',
        }
        BECH32_INVALID = {
        ...
        for l in BECH32_INVALID:
            ...
            assert_raises_rpc_error(
                -5,
                "Address is not valid" if self.options.descriptors else "Invalid Aegisum address or script",
