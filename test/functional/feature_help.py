...
"""Verify that starting aegisum with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start aegisum with -h for help text")
        ...
        self.log.info("Start aegisum with -version for version information")
        ...
        self.log.info("Start aegisumd with -fakearg to make sure it does not start")
