...
ADDRESS_BCRT1_UNSPENDABLE = 'raegs1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqe9kxtl'
ADDRESS_BCRT1_UNSPENDABLE_DESCRIPTOR = 'addr(raegs1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqe9kxtl)#xm6azk0m'
# Coins sent to this address can be spent with a witness stack of just OP_TRUE
ADDRESS_BCRT1_P2WSH_OP_TRUE = 'raegs1qft5p2uhsdcdc3l2ua4ap5qqfg4pjaqlp250x7us7a8qqhrxrxfsqc6h8ge'
...
def program_to_witness(version, program, main=False):
    ...
    return encode_segwit_address("aegs" if main else "raegs", version, program)
