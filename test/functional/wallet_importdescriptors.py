...
class ImportDescriptorsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        addresses += ["raegs1qrd3n235cj2czsfmsuvqqpr3lu6lg0ju7w49wld", "raegs1qfqeppuvj0ww98r6qghmdkj70tv8qpchef5j2le"] # wpkh subscripts corresponding to the above addresses
        ...
        addresses = [
            'raegs1qtmp74ayg7p24uslctssvjm06q5phz4yrc3zpyj', # m/0'/0'/0
            'raegs1q8vprchan07gzagd5e6v9wd7azyucksq2c4ynpe', # m/0'/0'/1
            'raegs1qtuqdtha7zmqgcrr26n2rqxztv5y8rafjlg94gz', # m/0'/0'/2
            'raegs1qau64272ymawq26t90md6an0ps99qkrse22pnz3', # m/0'/0'/3
            'raegs1qsg97266hrh6cpmutqen8s4s962aryy77vv4ql3', # m/0'/0'/4
        ]
        ...
        assert_equal(addr, 'raegs1qdt0qy5p7dzhxzmegnn4ulzhard33s2809arjqgjndx87rv5vd0fqzmggt2') # Derived at m/84'/0'/0'/0
        change_addr = wmulti_priv.getrawchangeaddress('bech32')
        assert_equal(change_addr, 'raegs1qt9uhe3a9hnq7vajl7a094z4s3crm9ttf8zw3f5v9gr2nyd7e3lnsvklvg5')
        ...
        assert_equal(addr, 'raegs1qp8s25ckjl7gr6x2q3dx3tn2pytwp05upkjztk6ey857tt50r5aeqme3nvg') # Derived at m/84'/0'/0'/1
