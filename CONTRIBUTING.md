Contributing to Aegisum Core
============================

The Aegisum Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Aegisum Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/aegisum-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to aegisum-qt
...
The following applies to code changes to the Aegisum Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Aegisum
Network Protocol consensus changes.

Whether a pull request is merged into Aegisum Core rests with the project merge
...
Patches that change Aegisum consensus rules are considerably more involved than
...
Where a patch set proposes to change the Aegisum consensus, it must have been
...
The project leader is the release manager for each Aegisum Core release.
