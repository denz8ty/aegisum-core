...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " aegisum-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  aegisum-tx [options] <hex-tx> [commands]  Update hex-encoded aegisum transaction\n" +
            "or:     aegisum-tx [options] -create [commands]   Create hex-encoded aegisum transaction\n" +
            "\n";
