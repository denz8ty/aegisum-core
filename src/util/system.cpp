...
const char * const BITCOIN_CONF_FILENAME = "aegisum.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Aegisum";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Aegisum";
#else
    // Unix-like
    return pathRet / ".aegisum";
#endif
#endif
}
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (copyright_devs.find("Bitcoin Core") == std::string::npos) {
            ...
            strYear.replace(strYear.find("2025"), sizeof("2025")-1, "2011-2025");
            strCopyrightHolders += "\n" + strYear + "The Litecoin Core developers";
            strYear.replace(strYear.find("2011-2025"), sizeof("2011-2025")-1, "2009-2025");
